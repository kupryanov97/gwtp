  ...
  private void cellTableStyleInitializer() {
    cellTableStyle = new com.google.gwt.user.cellview.client.CellTable.Style() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? (".GI4BLCC-d-g{border-top:2px solid #6f7277;padding:3px 15px;text-align:right;color:#4b4a4a;text-shadow:#ddf 1px 1px 0;overflow:hidden}.GI4BLCC-d-h{border-bottom:2px solid #6f7277;padding:3px 15px;text-align:right;color:#4b4a4a;text-shadow:#ddf 1px 1px 0;overflow:hidden}.GI4BLCC-d-a{padding:2px 15px;overflow:hidden}.GI4BLCC-d-v{cursor:pointer;cursor:hand}.GI4BLCC-d-v:hover{color:#6c6b6b}.GI4BLCC-d-b{background:#fff}.GI4BLCC-d-c{border:2px solid #fff}.GI4BLCC-d-r{background:#f3f7fb}.GI4BLCC-d-s{border:2px solid #f3f7fb}.GI4BLCC-d-i{background:#eee}.GI4BLCC-d-j{border:2px solid #eee}.GI4BLCC-d-l{background:#ffc}.GI4BLCC-d-m{border:2px solid #ffc}.GI4BLCC-d-t{background:#628cd5;color:white;height:auto;overflow:auto}.GI4BLCC-d-u{border:2px solid #628cd5}.GI4BLCC-d-k{border:2px solid #d7dde8}.GI4BLCC-d-q{margin:30px}") : (".GI4BLCC-d-g{border-top:2px solid #6f7277;padding:3px 15px;text-align:left;color:#4b4a4a;text-shadow:#ddf 1px 1px 0;overflow:hidden}.GI4BLCC-d-h{border-bottom:2px solid #6f7277;padding:3px 15px;text-align:left;color:#4b4a4a;text-shadow:#ddf 1px 1px 0;overflow:hidden}.GI4BLCC-d-a{padding:2px 15px;overflow:hidden}.GI4BLCC-d-v{cursor:pointer;cursor:hand}.GI4BLCC-d-v:hover{color:#6c6b6b}.GI4BLCC-d-b{background:#fff}.GI4BLCC-d-c{border:2px solid #fff}.GI4BLCC-d-r{background:#f3f7fb}.GI4BLCC-d-s{border:2px solid #f3f7fb}.GI4BLCC-d-i{background:#eee}.GI4BLCC-d-j{border:2px solid #eee}.GI4BLCC-d-l{background:#ffc}.GI4BLCC-d-m{border:2px solid #ffc}.GI4BLCC-d-t{background:#628cd5;color:white;height:auto;overflow:auto}.GI4BLCC-d-u{border:2px solid #628cd5}.GI4BLCC-d-k{border:2px solid #d7dde8}.GI4BLCC-d-q{margin:30px}");
      }
    }
    ;
  }
