  ...
  private void styleInitializer() {
    style = new com.google.gwt.user.client.ui.NativeHorizontalScrollbar_NativeHorizontalScrollbarUiBinderImpl_GenCss_style() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? (".GI4BLCC-j-c{position:relative;overflow:hidden}.GI4BLCC-j-b{position:absolute;right:0;bottom:0;width:100%;height:100px;overflow:auto;overflow-x:scroll;overflow-y:hidden}.GI4BLCC-j-a{height:1px}") : (".GI4BLCC-j-c{position:relative;overflow:hidden}.GI4BLCC-j-b{position:absolute;left:0;bottom:0;width:100%;height:100px;overflow:auto;overflow-x:scroll;overflow-y:hidden}.GI4BLCC-j-a{height:1px}");
      }
